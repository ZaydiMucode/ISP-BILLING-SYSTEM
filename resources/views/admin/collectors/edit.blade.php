                ...
                <form action="{{ route('admin.collectors.update', $collector) }}" method="POST" class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="area_coverage" value="{{ old('area_coverage', $collector->area_coverage) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500" placeholder="e.g., South Jakarta, Riverside">
                        </div>
                    </div>
