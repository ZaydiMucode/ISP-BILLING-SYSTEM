        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Add IP Monitor</h1>
                        <p class="text-gray-400">Add a new IP address to monitor</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    <form action="{{ route('admin.ip-monitor.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Name / Label</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Network Device (Optional)</label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="alert_threshold" value="{{ old('alert_threshold', 3) }}" required min="1" max="10"
                                           class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500">
                                    <p class="text-gray-500 text-xs mt-1">Number of consecutive failures before alert</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-6">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="alert_enabled" value="1" {{ old('alert_enabled', true) ? 'checked' : '' }}
                                           class="w-4 h-4 text-cyan-600 bg-gray-700 border-gray-600 rounded focus:ring-cyan-500">
                                    <span class="ml-2 text-gray-300">Send Alert (WhatsApp)</span>
                                </label>
                            </div>
                        </div>
