                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="currency_symbol" value="{{ $settings['currency_symbol'] ?? '₱' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
