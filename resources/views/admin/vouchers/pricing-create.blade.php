...
@section('title', 'Add Voucher Pricing')
    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Add Voucher Pricing</h1>
            </div>
                    ...
                    <form action="{{ route('admin.vouchers.pricing.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="package_name" value="{{ old('package_name') }}" required
                                   placeholder="Example: 1 Hour Voucher"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Customer Price (₱)</label>
                                <input type="number" name="customer_price" value="{{ old('customer_price', 0) }}" required min="0"
                                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Agent Price (₱)</label>
                        ...
                        <div class="flex items-center space-x-4 pt-4 border-t">
                            ...
                            <a href="{{ route('admin.vouchers.pricing') }}" class="text-gray-600 hover:text-gray-900">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
