...
<head>
    ...
    <title>Track Order - {{ companyName() }}</title>
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
                <h1 class="text-2xl font-bold text-gray-900 mb-4">
                    <i class="fas fa-search text-cyan-600 mr-2"></i>Track Order
                </h1>
                <form method="GET" class="flex gap-3">
                    <input type="text" name="order_number" value="{{ request('order_number') }}" placeholder="Enter Order No. or Phone Number" class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-cyan-500 to-blue-600 text-white p-6">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-sm opacity-80">Order Number</p>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex justify-between">
                                @foreach(['Pending', 'Confirmed', 'Scheduled', 'Installing', 'Completed'] as $index => $label)
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                        <p class="text-red-800 font-medium"><i class="fas fa-times-circle mr-2"></i>Order Cancelled</p>
                    </div>
                    @endif
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-cyan-600">₱ {{ number_format($order->total_amount, 0, ',', '.') }}</p>
                        </div>
                        <div>
                    ...
                    <div class="mt-4 pt-4 border-t">
                        <p class="text-gray-500 text-sm">Installation Address</p>
