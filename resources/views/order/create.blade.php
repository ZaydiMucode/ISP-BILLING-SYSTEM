                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <h1 class="text-2xl font-bold text-gray-900 mb-6">
                            <i class="fas fa-shopping-cart text-cyan-600 mr-2"></i>Registration Form
                        </h1>
                        ...
                        <form action="{{ route('order.store') }}" method="POST" id="orderForm">
                            ...
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b">
                                    <i class="fas fa-user mr-2 text-cyan-600"></i>Personal Information
                                </h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Full Name *</label>
                                        <input type="text" name="customer_name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500" placeholder="Full name as per ID card">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">ID Card Number (NIK)</label>
                                        <input type="text" name="customer_nik" maxlength="16" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500" placeholder="16 digit ID number">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b">
                                    <i class="fas fa-map-marker-alt mr-2 text-cyan-600"></i>Installation Address
                                </h3>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Full Address *</label>
                                    <textarea name="customer_address" rows="3" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500" placeholder="Street, Block, District, City"></textarea>
                                </div>
                                <input type="hidden" name="latitude" id="latitude">
                                <input type="hidden" name="longitude" id="longitude">
                                <button type="button" onclick="getLocation()" class="mt-2 text-sm text-cyan-600 hover:text-cyan-800">
                                    <i class="fas fa-crosshairs mr-1"></i>Get GPS Location
                                </button>
                            ...
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b">
                                    <i class="fas fa-plug mr-2 text-cyan-600"></i>Connection Type
                                </h3>
                                    ...
                                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-cyan-500 transition" id="pppoe-label">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Fiber optic cable</p>
                                            </div>
                                        </div>
                                    </label>
                                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-cyan-500 transition" id="hotspot-label">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Wireless connection</p>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                            ...
                            <div class="mb-6">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b">
                                    <i class="fas fa-credit-card mr-2 text-cyan-600"></i>Payment Method
                                </h3>
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:border-cyan-500 transition" id="manual-label">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Admin confirmation</p>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="customer_notes" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500" placeholder="Additional notes for installation..."></textarea>
                            </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4">
                        ...
                        <div class="bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg p-4 mb-4">
                            <p class="text-sm opacity-80">Selected Package</p>
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-600">Package Fee/month</span>
                                <span class="font-medium">₱ {{ number_format($package->price, 0, ',', '.') }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Installation Fee</span>
                                <span class="font-medium">₱ 500.00</span>
                            </div>
                            <hr>
                            <div class="flex justify-between text-lg font-bold">
                                <span>Total Payment</span>
                                <span class="text-cyan-600">₱ {{ number_format($package->price + 150000, 0, ',', '.') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 p-3 bg-yellow-50 rounded-lg">
                            <p class="text-xs text-yellow-800">
                                ...
                                Initial payment includes installation fee + first month's subscription.
                            </p>
                        </div>

                        <div class="mt-4 space-y-2 text-xs text-gray-500">
                            <p><i class="fas fa-check text-green-500 mr-1"></i> Free location survey</p>
                            <p><i class="fas fa-check text-green-500 mr-1"></i> 1-year device warranty</p>
                            <p><i class="fas fa-check text-green-500 mr-1"></i> 24/7 Support</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    status.innerHTML = '<i class="fas fa-check text-green-500"></i> Location retrieved successfully';
                },
                (error) => {
                    status.innerHTML = '<i class="fas fa-times text-red-500"></i> Failed to retrieve location';
                }
            );
        } else {
