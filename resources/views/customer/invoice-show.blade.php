        ...
        <div class="mb-6">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    <tr>
                        <td class="px-4 py-4">
                            <p class="font-medium text-gray-900">{{ $invoice->package->name ?? 'Internet Service' }}</p>
                    ...
                    <tr>
                        <td class="px-4 py-4 text-right text-gray-600">VAT (PPN)</td>
                        <td class="px-4 py-4 text-right font-medium text-gray-900">
        ...
        @if($invoice->status === 'unpaid')
            ...
            @if($invoice->payment_url)
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <p class="text-blue-800 font-medium mb-2">Payment link already created</p>
                    <a href="{{ $invoice->payment_url }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                        <i class="fas fa-external-link-alt mr-2"></i>Continue to Payment
                    </a>
                </div>
            @elseif($duitkuEnabled)
                <div class="border-t pt-6">
                    ...
                    <div class="space-y-4" id="paymentMethods">
                        <!-- QRPH TO BE ADDED SOON -->
                        <div>
                            <p class="text-sm font-medium text-gray-500 mb-2">QRPH (All E-Wallets)</p>
                            <button type="button" onclick="selectPayment('SP')" class="w-full flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                ...
                                <div class="text-left flex-1">
                                    <p class="font-semibold text-gray-900">QRPH</p>
                                    <p class="text-sm text-gray-500">Scan with Gcash, Maya, Maribank, etc</p>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <button type="button" onclick="selectPayment('OV')" class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mb-2">
                                        <span class="text-purple-600 font-bold text-xs">Gcash</span>
                                    </div>
                                    <span class="font-medium text-gray-900 text-xs">Gcash</span>
                                </button>
                                <button type="button" onclick="selectPayment('DA')" class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mb-2">
                                        <span class="text-blue-600 font-bold text-xs">PayMaya</span>
                                    </div>
                                    <span class="font-medium text-gray-900 text-xs">Paymaya</span>
                                </button>
            ...
            @else
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p class="text-yellow-800">Online payment is currently unavailable. Please contact admin for payment information.</p>
                </div>
            @endif
        @else
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="font-semibold text-green-800">Invoice has been paid</p>
